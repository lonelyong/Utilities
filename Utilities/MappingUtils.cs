...
namespace Utilities
{
	...
	/// </summary>
	 public static class MappingUtils
	 {
		...
		public static T MapPropertiesFrom<T>(this T targetObj, params object[] sourceObjs) where T : class, new()
        {
		...
		/// <param name="sourceObjs">源对象集合</param>
		/// <returns>目标对象</returns>
		public static T MapFieldsFrom<T>(this T targetObj, params object[] sourceObjs) where T : class, new()
        {
			if (!sourceObjs.IsNullOrEmpty())
			{
				foreach (var obj in sourceObjs)
		...
		/// <param name="sourceObjs">源对象集合</param>
		/// <returns>目标对象</returns>
		public static T MapFrom<T>(this T targetObj, params object[] sourceObjs) where T : class, new()
        {
		...
		/// <returns>目标对象</returns>
		public static T MapPropertiesTo<T>(this object sourceObj, T targetObj) where T : class, new()
        {
		...
		/// <param name="targetObj">目标对象</param>
		/// <returns>目标对象</returns>
		public static T MapFieldsTo<T>(this object sourceObj, T targetObj) where T : class, new()
        {
			if (sourceObj == null) return targetObj;
			var t = targetObj;
		...
		/// <param name="targetObj">目标对象</param>
		/// <returns>目标对象</returns>
		public static T MapTo<T>(this object sourceObj, T targetObj) where T : class, new()
        {
			var t = targetObj;
			MapPropertiesTo<T>(sourceObj, t);
			MapFieldsTo<T>(sourceObj, t);
