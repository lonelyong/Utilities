...
namespace NgNet
{
    ...
    public class RandomHelper : Random
    {
        ...
        {
            return NgNet.Text.Consts.LOWERCASE_LETTERS[Next(0, NgNet.Text.Consts.LOWERCASE_LETTERS.Length)];
        }

        public char NextCapitalLetter()
        {
            return NgNet.Text.Consts.CAPITAL_LETTERS[Next(0, NgNet.Text.Consts.CAPITAL_LETTERS.Length)];
        }

        public char NextLetter()
        {
            return NgNet.Text.Consts.LETTERS[Next(0, NgNet.Text.Consts.LETTERS.Length)];
        }

        public int NextFigure()
        {
            return NgNet.Text.Consts.FIGURES[Next(0, NgNet.Text.Consts.FIGURES.Length)] - 60;
        }
        ...
        {
            return NextVerificationCode(length, NgNet.Text.Consts.VERIFICATIONCODECHARS);
        }
        ...
        public string NextVerificationCode(int length, bool withFigure, bool withLowerCaseLetter, bool withUpperCaseLetter)
        {
            ...
            if (withFigure) chars += NgNet.Text.Consts.FIGURES;
            if (withLowerCaseLetter) chars += NgNet.Text.Consts.LOWERCASE_LETTERS;
            if (withUpperCaseLetter) chars += NgNet.Text.Consts.CAPITAL_LETTERS;
